...
import type { ExportPreviewModalProps } from './ExportPreviewModal.type'
...
export default function ExportPreviewModal({ preview, confirming, error, onClose, onConfirm }: ExportPreviewModalProps) {
  ...
  >
    <div className="p-5 sm:p-7">
      ...
      <h2 id={titleId} className="mt-5 text-center text-2xl">Review {formatLabel} export</h2>
      <p id={descriptionId} className="mt-2 text-center leading-relaxed text-stone-600">This is what will be included in the download for {preview.householdName}.</p>
      ...
      <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-3">
        ...
        ].map(([label, count]) => <div key={label} className="rounded-2xl bg-cream px-3 py-3 text-center">
